...
class CreateWillingbuildReportAttachedPhotoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('willingbuild_report_attached_photo', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('willingbuild_report_attached_photo');
    }
}
