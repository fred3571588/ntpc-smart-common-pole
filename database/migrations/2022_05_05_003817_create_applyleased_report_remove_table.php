...
class CreateApplyleasedReportRemoveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('applyleased_report_remove', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('applyleased_report_remove');
    }
}
