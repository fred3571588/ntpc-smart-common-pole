...
class CreateApplyleasedReportAttachedPhotoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('applyleased_report_attached_photo', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('applyleased_report_attached_photo');
    }
}
