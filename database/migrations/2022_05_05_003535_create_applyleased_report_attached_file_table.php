...
class CreateApplyleasedReportAttachedFileTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('applyleased_report_attached_file', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('applyleased_report_attached_file');
    }
}
