...
class CreateRentedReportRemovePhotoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rented_report_remove_photo', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('rented_report_remove_photo');
    }
}
